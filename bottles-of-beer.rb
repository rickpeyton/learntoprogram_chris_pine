...
puts 'Bottles of Beer on the wall program.'
puts 'How many bottles of beer would you like on the way?'
bottles = gets.chomp.to_i
# while bottles >= 1
# 	pbottles = englishNumber bottles
# 	puts pbottles + ' bottles of beer on the wall, ' + pbottles + ' bottles of beer'
# 	bottles = bottles - 1
# 	pbottles = englishNumber bottles
# 	puts 'if one of those bottles should happen to fall, ' + pbottles + ' bottles of beer on the wall'
# end
while bottles >= 1
	pbottles = englishNumber bottles
	puts pbottles + ' bottles of beer on the wall, ' + pbottles + ' bottles of beer'
